...
def combinar_enumerate(nombres: List[str], precios: List[float], ids: List[int]) -> Tuple[Any]:
    ...
    """
    lista = []
    for i, nombre_articulos in enumerate(nombres):
        lista.append((nombre_articulos, precio_articulos[i], id_articulos[i]))
    return tuple(lista)
...
def combinar_zip(nombres: List[str], precios: List[float], ids: List[int]) -> Tuple[Any]:
    ...
    """
    return tuple(zip(nombre_articulos, precio_articulos, id_articulos))
